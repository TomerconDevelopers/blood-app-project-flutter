  ...
  asyncFunc(BuildContext) async {
   ...
   Future<void> verifyPhone(phoneNo) async {
    ...
    final PhoneCodeSent smsSent = (String verId, [int forceResend]) {
      this.verificationId = verId; ut.showtoast("Please Enter a Mobile in this device", Colors.black);
    //  setState(() {
      //  this.codeSent = true;
     // });
    };
            ...
            SingleChildScrollView(
                  ...
                  Container(
                    ...
                    child:
                          Column(
                            children: <Widget>[
                              Center(child: Text("Please enter your mobile number to continue",
                              style: TextStyle(
                                fontSize:15,
                                fontWeight:FontWeight.bold
                              ),
                              ...
                              TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      suffixIcon: otpverified? Icon(Icons.verified_user,color: Colors.green,):Text(""),
